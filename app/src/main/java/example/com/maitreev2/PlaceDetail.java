...
public class PlaceDetail extends AppCompatActivity {
    @Bind(R.id.placename)TextView placename;
    @Bind(R.id.basedesc)TextView basedesc;
    @Bind(R.id.extradesc)TextView extradesc;
    @Bind(R.id.coordinatorname)TextView coordinatorname;
    @Bind(R.id.placeicon)ImageView placeicon;
